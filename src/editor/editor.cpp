...
void editor::init() {
    ...
    // io.ConfigDpiScaleFonts = true;        // [Experimental] Automatically overwrite
    // style.FontScaleDpi in Begin() when Monitor DPI changes. This will scale fonts but _NOT_ scale
    // sizes/padding for now. io.ConfigDpiScaleViewports = true;    // [Experimental] Scale Dear
    // ImGui and Platform Windows when Monitor DPI changes.
